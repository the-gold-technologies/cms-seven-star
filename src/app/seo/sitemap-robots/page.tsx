...
export default function SitemapRobotsPage() {
  ...
  return (
    <section className="min-h-screen bg-[#F6F8FA] p-8 flex flex-col gap-8">
      <PageHeader
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 mt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between p-3.5 bg-gray-50 hover:bg-gray-100 border border-gray-100 rounded-2xl text-xs font-bold text-gray-700 transition-all group"
              >
